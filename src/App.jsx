...
export default function App(){
  return (
    ...
    >
      ...
      <div className=" max-w-[1280px] overscroll-none mx-auto relative -z-10">
        <picture className="">
          ...
          <img alt="" aria-hidden="true" width="4377" className="absolute top-0 pointer-events-none " style={{right: "-1050px", maxWidth: "calc(230vw + 1670px)"}} src="https://github.githubassets.com/images/modules/site/home-campaign/hero-bg.webp" />
        </picture>
      </div>
      <Header/>
    </div>
